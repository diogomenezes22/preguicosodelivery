PagSeguro Java Library - version 2.0.1
 
Please refer to the online documentation:
 
 - How to use PagSeguro as a payment solution for your website using the PagSeguro Java Library:
    https://pagseguro.uol.com.br/v2/guia-de-integracao/tutorial-da-biblioteca-pagseguro-em-java.html
 
 - Class library documentation:
    https://pagseguro.uol.com.br/v2/guia-de-integracao/documentacao-da-biblioteca-pagseguro-em-java.html
