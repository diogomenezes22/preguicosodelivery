...
public class ItemCardapioDAO extends DAOBase{
	...
	public List<ItemCardapio> retrieveItemByName(String nome) {
		List<ItemCardapio> itens = this.ofy().query(ItemCardapio.class).filter("nome", nome).order("estabelecimentoId").list();
		return itens;
