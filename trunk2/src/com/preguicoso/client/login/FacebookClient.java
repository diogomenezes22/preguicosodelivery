...
//	public static String login(String API_KEY, String SECRET_KEY,
//			final String email, final String password)
//			throws FacebookException, HttpException, IOException {
//		// LOGIN (finally got this one working )
//		// Creating an HttpClient instance used for requesting (GET and POST) to
//		// login
//		// The HttpClient should only be used for the login system
//		HttpClient http = new HttpClient();
//		// The host will be offcourse http://www.facebook.com
//		http.getHostConfiguration().setHost("www.facebook.com");
//		// Creating the client based on the public API_KEY and the private
//		// SECRET_KEY
//		FacebookXmlRestClient client = new FacebookXmlRestClient(API_KEY,
//				SECRET_KEY);
//		// Is this application a desktop application?
//		// TODO Check what the meaning of “isDesktop” exactly is (is mobile
//		// application a desktop application?)
//		// When false the friendlist cannot be obtained :/
//		// client.setIsDesktop(false);
//		// Create the authentication token
//		String token = client.auth_createToken();
//		System.out.println("LOGIN – Authentication Token created upon login: "
//				+ token);
...
//		System.out.println("LOGIN – Http status returned when executing GET: "
//				+ getStatus);
...
//				+ postStatus);
//		// Get the authentication session string, needed in the rest of the
//		// application
//		String session = client.auth_getSession(token);
//		System.out.println("LOGIN – The Authentication Session string: "
//				+ session);
//		// Request the userid of the currently logged in user, will be
//		// needed further on the application
//		long userid = client.users_getLoggedInUser();
//		System.out.println("LOGIN – Successfull login for user with id ‘"
//				+ userid + "‘");
//		return session;
//	}
// }